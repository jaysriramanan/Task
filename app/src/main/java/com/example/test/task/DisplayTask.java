...
import com.example.test.task.Views.SubTaskView;
...
public class DisplayTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dispTaskName=(TextView)findViewById(R.id.dispTaskName);
        dispTaskDetails=(TextView)findViewById(R.id.dispTaskDetails);
